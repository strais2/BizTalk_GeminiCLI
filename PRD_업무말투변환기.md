...
- [x] FastAPI 서버에 Staic Page(`index.html`) 및 정적 자산(CSS/JS) 라우팅 기능이 완벽하게 작동한다 
...
5. [x] `requirements.txt` 작성하고 라이브러리 버전(use context7)을 명시해야 함
...
3. [x] `tone_converter.py` — 핵심 변환 로직 구현(LangChain + Solar-Pro3 연동)
